...
import '../../data/network/apis/github/github_client.dart' as _i9;
...
class AppComponent$Injector implements _i1.AppComponent {
  ...
  static _i5.Future<_i1.AppComponent> create(_i2.ParkomatModule parkomatModule) async {
  ...
  _i7.ParkomatClient _createParkomatClient() => _i7.ParkomatClient(_createDio());
  _i9.GithubClient _createGithubClient() => _i9.GithubClient(_createDio());
  _i3.Dio _createDio() => _dio;
  _i8.MainBloc _createMainBloc() => _i8.MainBloc(_createParkomatClient(), _createSharedPreferenceCache(), _createGithubClient());
  _i4.SharedPreferenceCache _createSharedPreferenceCache() => _singletonSharedPreferenceCache ??= _parkomatModule.provideSharedPreferenceCache();
  _i9.SettingsBloc _createSettingsBloc() => _i9.SettingsBloc(_createParkomatClient(), _createSharedPreferenceCache());
  @override
  _i6.ParkomatApp get app => _createParkomatApp();
  @override
  _i7.ParkomatClient get parkomatClient => _createParkomatClient();
  @override
  _i9.GithubClient get githubClient => _createGithubClient();
  @override
